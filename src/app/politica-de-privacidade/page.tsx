    ...
    <>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          A sua privacidade é importante para nós. É política do Família
          Missionária respeitar a sua privacidade em relação a qualquer
          informação sua que possamos coletar no site{" "}
          <a href="https://fm-communities.vercel.app">Família Missionária</a>, e
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          informação que o Família Missionária oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            ...
            (softwares) do Família Missionária, de seus fornecedores ou
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Esta política é efetiva a partir de&nbsp;9 July 2024 16:49
        </span>
      </p>
    </>
  );
