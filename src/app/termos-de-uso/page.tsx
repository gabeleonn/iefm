    ...
    <>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Ao acessar ao site{" "}
          <a href="https://fm-communities.vercel.app">Família Missionária</a>,
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          materiais (informações ou software) no site Família Missionária ,
      ...
      <ol>
        ...
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            ...
            contido no site Família Missionária;&nbsp;
          </span>
        </li>
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          dessas restrições e poderá ser rescindida por Família Missionária a
      ...
      <ol>
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            Os materiais no site da Família Missionária são fornecidos
            &apos;como estão&apos;. Família Missionária não oferece garantias,
        ...
        <li>
          <span style={{ color: "rgb(68, 68, 68)" }}>
            Além disso, o Família Missionária não garante ou faz qualquer
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Em nenhum caso o Família Missionária ou seus fornecedores serão
          ...
          decorrentes do uso ou da incapacidade de usar os materiais em Família
          Missionária, mesmo que Família Missionária ou um representante
          autorizado da Família Missionária tenha sido notificado oralmente ou
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          Os materiais exibidos no site da Família Missionária podem incluir
          erros técnicos, tipográficos ou fotográficos. Família Missionária não
          garante que qualquer material em seu site seja preciso, completo ou
          atual. Família Missionária pode fazer alterações nos materiais
          contidos em seu site a qualquer momento, sem aviso prévio. No entanto,
          Família Missionária não se compromete a atualizar os materiais.
        </span>
      </p>
      <h2>
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          O Família Missionária não analisou todos os sites vinculados ao seu
          site e não é responsável pelo conteúdo de nenhum site vinculado. A
          inclusão de qualquer link não implica endosso por Família Missionária
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          O Família Missionária pode revisar estes termos de serviço do site a
      ...
      <p>
        <span style={{ color: "rgb(68, 68, 68)" }}>
          ...
          leis do Família Missionária e você se submete irrevogavelmente à
